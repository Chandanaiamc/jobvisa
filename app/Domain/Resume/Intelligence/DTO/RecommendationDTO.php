...
/**
 * Actionable recommendation for the resume owner.
 */
final class RecommendationDTO
{
    ...
    public static function fromArray(array $row): self
    {
        return new self(
            ...
            estimatedImprovement: (int) ($row['estimated_score_improvement'] ?? $row['estimatedImprovement'] ?? 0),
            actionUrl: (string) ($row['action_url'] ?? $row['actionUrl'] ?? ''),
        );
    }
}
